function bestMove(log_grid)
{
    ...
    var c_best_direction = Module.cwrap('c_best_direction', 'number', ['number','number','number','number','number','number','number','number','number','number','number','number','number','number','number','number']);
